...
<div class="main-sidebar">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="index.jsp">COSMO Home</a>
          </div>
          <div class="sidebar-user">
            <div class="sidebar-user-picture">
              <img alt="세션이름" src="/img/avatar/ike.jpg">
            </div>
            <div class="sidebar-user-details">
              ...
              <div class="user-role">
                	...
                	사용자 </c:if>
                	<c:if test="${sessionScope.SESS_GUBUN == ' '}">
                	게스트 </c:if>
                	<!-- decode(mgubun,'u','사용자','a','관리자') as user_gubun -->
...
<!-- basic href 변경했음!!!!!! -->
                <li><a href="shop_detail.jsp"><i class="ion ion-ios-circle-outline"></i> Basic</a></li>
