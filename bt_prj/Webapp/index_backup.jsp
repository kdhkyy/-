  ...
  <script>function getLocation() {
	  if (navigator.geolocation) { // GPS를 지원하면
		    navigator.geolocation.getCurrentPosition
		  	  ...
		  	  (function(position) {
		  		  <!-- json형식 {key:velue}
		  		  var ourCoords = {latitude : 37.5666263, longitude : 126.9783924}; 
		  		  -->
		  		 ...
		  		 var shoplng = ${vv.lng};
		  		 <!--
		  		 var shoplat = 37.5666263;
		  		 var shoplng = 126.9783924;
		  		  -->
		      ...
		      alert(mylat + ' ' + mylng + ' ' + "현재위치에서" + distance + "km 떨어져있습니다.");
		      </c:forEach>
		    }, function(error) {
		      console.error(error);
		    }, {
