...
$(document).ready(function(){
   ...
   function handleImgFileSelect(e) {
         $("#prev-img-div").empty();//리무브는 객체가 지워지고 empty는 비우기
...
<body>
  <div id="app">
    ...
    <div id="ex2_postcodify" class="postcodify_search_form postcode_search_form"></div>
    <!-- <div class="postcodify_search_controls postcode_search_controls"><label for="postcodify_15420031513189814" style="display: none;">검색 키워드</label><input type="text" class="keyword" value="" id="postcodify_15420031513189814" style="width: 550px;"><button type="button" class="search_button" id="postcodify_15420031513189814_button">검색</button></div> -->
